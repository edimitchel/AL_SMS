	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		while (i++ < 8) {
			navDrawerItems.add(new NavDrawerItem(navMenuTitles[6], navMenuIcons
					.getResourceId(6, -1), true, "1 mess"));
		}*/

		// adding nav drawer items to array
		/*
		 * // Home navDrawerItems.add(new NavDrawerItem(navMenuTitles[0],
		 * navMenuIcons.getResourceId(0, -1))); // Find People
		 * navDrawerItems.add(new NavDrawerItem(navMenuTitles[1],
		 * navMenuIcons.getResourceId(1, -1))); // Photos navDrawerItems.add(new
		 ...
		 * true, "50+")); // Contacts, We will add a counter here
		 * navDrawerItems.add(new NavDrawerItem(navMenuTitles[6],
		 * navMenuIcons.getResourceId(6, -1), true, "1 mess"));
		 */
