...
public class BluetoothService extends ConnectiviteFactory {
	// Debugging
		...
		protected void connectionFailed() {
			...
			Bundle bundle = new Bundle();
			bundle.putString(Globales.TOAST, "Impossible de se connecter au périphérique");
			msg.setData(bundle);
			mHandler.sendMessage(msg);
		}
		...
		protected void connectionLost() {
			...
			Bundle bundle = new Bundle();
			bundle.putString(Globales.TOAST, "La connexion avec le périphérique a été perdue");
			msg.setData(bundle);
			mHandler.sendMessage(msg);
		}
